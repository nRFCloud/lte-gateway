...
int service_info_json_object_encode(
	...
	const uint32_t fota_count, const uint16_t fota_version, const bool ble_fota,
	cJSON * const obj_out)
{
	int err = 0;
	...
	cJSON_AddBoolToObjectCS(service_info_obj, "fota_v2_ble", ble_fota); /* WORK IN PROGRESS */
#endif
